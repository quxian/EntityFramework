...
namespace Microsoft.Data.Entity.Metadata.Internal.Test
{
    public class InternalModelBuilderTest
    {
        ...
        public void Can_ignore_lower_source_entity_type_using_entity_type_name()
        {
            ...
            Assert.Equal(Strings.CannotIgnoreExplicitEntityType(typeof(Customer).FullName),
                Assert.Throws<InvalidOperationException>(() =>
                    Assert.NotNull(modelBuilder.Ignore(typeof(Customer).FullName, ConfigurationSource.Explicit))).Message);
        }
        ...
        public void Cannot_ignore_existing_entity_type_using_entity_clr_type()
        {
            ...
            Assert.Equal(Strings.CannotIgnoreExplicitEntityType(typeof(Customer).FullName),
                Assert.Throws<InvalidOperationException>(() =>
                    Assert.NotNull(modelBuilder.Ignore(typeof(Customer), ConfigurationSource.Explicit))).Message);
